  ...
  [
    {
      ...
      amount_en: "NT$40,000 per month, up to 4 academic years.",
      description:
      ...
      period_en: "For eligible 111-112 academic year students.",
      program_key: "nstc-doctoral",
      route_path: "/scholarships/nstc-doctoral",
      status_label: "已開放",
      status_label_en: "Open",
      title: "國科會-培育優秀博士生獎學金",
      title_en: "NSTC Scholarship for Outstanding Doctoral Students",
    },
    {
      amount: "每月 4 萬元，至多 3 學年",
      amount_en: "NT$40,000 per month, up to 3 academic years.",
      description:
        "填寫基本資料、請領資格、學術表現、研究參與與指定文件上傳。",
      description_en:
      ...
      period_en: "For incoming doctoral students in the specified academic year.",
      program_key: "nstc-research-grant",
      route_path: "/scholarships/nstc-research-grant",
      status_label: "測試中",
      status_label_en: "Testing",
      title: "國科會-博士生研究獎助學金(適用114學年度入學新生)",
      title_en: "NSTC Doctoral Research Grant",
    },
    {
      amount: "每月 4 萬元，至多 4 學年",
      amount_en: "NT$40,000 per month, up to 4 academic years.",
      ...
      is_visible: true,
      period: "新生獎學金",
      period_en: "New Student Scholarship.",
      program_key: "presidential-new-student",
      route_path: "/scholarships/presidential-new-student",
      status_label: "測試中",
      status_label_en: "Testing",
      title: "校長獎學金 (新生獎學金)",
      title_en: "Presidential Scholarship (New Student Scholarship)",
    },
    {
      amount: "每月 4 萬元，至多 3 學年",
      amount_en: "NT$40,000 per month, up to 3 academic years.",
      ...
      period_en: "For first- to third-year doctoral students in the 115 academic year.",
      program_key: "moe-doctoral",
      route_path: "/scholarships/moe-doctoral",
      status_label: "測試中",
      status_label_en: "Testing",
      title: "教育部-博士生獎學金(適用114學年度博士班1至3年級學生)",
      title_en: "MOE Doctoral Scholarship (For 115 Academic Year Doctoral Years 1-3)",
    },
    {
      ...
      is_visible: true,
      period: "適用本院全時博士生",
      period_en: "For full-time doctoral students in the College.",
      program_key: "full-time-doctoral-grant",
      route_path: "/scholarships/full-time-doctoral-grant",
      status_label: "測試中",
      status_label_en: "Testing",
      title: "全時博士生助學金",
      title_en: "Full-Time Doctoral Student Grant",
    },
  ];
